# ============================================
# DASHBOARD PARADISE-SYSTEMLABS v2.0
# ============================================
# Version: 2.0 - Arquitectura Modular
# Lineas: ~100 (vs 777 en v1.0)
...
Write-Host "  DASHBOARD PARADISE-SYSTEMLABS v2.0" -ForegroundColor Green
Write-Host "  Arquitectura Modular" -ForegroundColor Green
...
} -Theme (New-UDTheme -Name "Paradise" -Definition @{
    palette = @{
        primary = @{
            main = $Colors.Primary
        }
